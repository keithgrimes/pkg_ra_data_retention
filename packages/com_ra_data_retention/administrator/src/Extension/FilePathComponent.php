...
/**
 * Component class for Filepath
 *
 * @since  1.0.0
 */
class FilepathComponent extends MVCComponent implements RouterServiceInterface, BootableExtensionInterface, CategoryServiceInterface
{

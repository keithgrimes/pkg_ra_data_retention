...
/**
 * Component class for Filetable
 *
 * @since  1.0.0
 */
class FiletableComponent extends MVCComponent implements RouterServiceInterface, BootableExtensionInterface, CategoryServiceInterface
{

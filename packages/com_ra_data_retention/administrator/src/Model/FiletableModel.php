 ...
 * @since  1.0.0
 */
class FiletableModel extends AdminModel
{
	/**
	 ...
	 * @since  1.0.0
	 */
	public $typeAlias = 'com_ra_data_retention.retention.filetable';
	 ...
	 * @since   1.0.0
	 */
	public function getTable($type = 'Filetable', $prefix = 'Administrator', $config = array())
	{
	...
	public function getForm($data = array(), $loadData = true)
	{
		...
		// Get the form.
		$form = $this->loadForm(
								'com_ra_data_retention.filetable', 
								'filetable',
								array(
									'control' => 'jform',
									'load_data' => $loadData 
	...
	protected function loadFormData()
	{
		...
		$data = Factory::getApplication()->getUserState('com_ra_data_retention.edit.filetable.data', array());
	...
	protected function prepareTable($table)
	{
		...
		if (empty($table->id))
		{
			...
			{
				$db = $this->getDbo();
				$db->setQuery('SELECT MAX(ordering) FROM #__ra_retention_filetables');
				$max             = $db->loadResult();

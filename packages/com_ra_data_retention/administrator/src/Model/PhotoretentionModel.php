 ...
 * @since  1.0.0
 */
class PhotoretentionModel extends AdminModel
{
	/**
	 ...
	 * @since  1.0.0
	 */
	public $typeAlias = 'com_ra_data_retention.retention.photoretention';
	 ...
	 * @since   1.0.0
	 */
	public function getTable($type = 'photoretention', $prefix = 'Administrator', $config = array())
	{
	...
	public function getForm($data = array(), $loadData = true)
	{
		...
		// Get the form.
		$form = $this->loadForm(
								'com_ra_data_retention.photoretention', 
								'photoretention',
								array(
									'control' => 'jform',
									'load_data' => $loadData 
	...
	protected function loadFormData()
	{
		...
		$data = Factory::getApplication()->getUserState('com_ra_data_retention.edit.photoretention.data', array());
	...
	public function save($data)
	{
		...
		// Ra_data_retentionHelper::CalculateFullPhotoRetentions($testmode);
		return $status;
	}
}

 ...
 * @since  1.0.0
 */
class WeblinkretentionModel extends AdminModel
{
	/**
	 ...
	 * @since  1.0.0
	 */
	public $typeAlias = 'com_ra_data_retention.retention.weblinkretention';
	 ...
	 * @since   1.0.0
	 */
	public function getTable($type = 'Weblinkretention', $prefix = 'Administrator', $config = array())
	{
	...
	public function getForm($data = array(), $loadData = true)
	{
		...
		// Get the form.
		$form = $this->loadForm(
								'com_ra_data_retention.weblinkretention', 
								'weblinkretention',
								array(
									'control' => 'jform',
									'load_data' => $loadData 
	...
	protected function loadFormData()
	{
		...
		$data = Factory::getApplication()->getUserState('com_ra_data_retention.edit.weblinkretention.data', array());
	...
	public function save($data)
	{
		...
		// Ra_data_retentionHelper::CalculateFullWeblinkRetentions($testmode);
		return $status;
	}
}

...
namespace Ramblerswebs\Component\Ra_data_retention\Administrator\Table;
// No direct access
 ...
 * @since 1.0.0
 */
class CalculatedretentionTable extends Table implements VersionableTableInterface, TaggableTableInterface
{
	...
	{
		$this->typeAlias = 'com_ra_data_retention.calculatedretention';
		parent::__construct('#__ra_calc_retention_categories', 'id', $db);
	...
	protected function _getAssetParentId($table = null, $id = null)
	{
		...
		$assetParent->loadByName('com_ra_data_retention');

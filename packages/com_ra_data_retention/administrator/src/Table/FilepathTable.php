 ...
 * @since 1.0.0
 */
class FilepathTable extends Table implements VersionableTableInterface, TaggableTableInterface
{
	...
	{
		$this->typeAlias = 'com_ra_data_retention.filepath';
		parent::__construct('#__ra_retention_filepaths', 'id', $db);

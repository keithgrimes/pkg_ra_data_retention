 ...
 * @since 1.0.0
 */
class FiletableTable extends Table implements VersionableTableInterface, TaggableTableInterface
{
	...
	{
		$this->typeAlias = 'com_ra_data_retention.filetable';
		parent::__construct('#__ra_retention_filetables', 'id', $db);

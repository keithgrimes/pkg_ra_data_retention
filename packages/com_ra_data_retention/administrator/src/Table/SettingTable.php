 ...
 * @since 1.0.0
 */
class SettingTable extends Table implements VersionableTableInterface, TaggableTableInterface
{
	...
	{
		$this->typeAlias = 'com_ra_data_retention.setting';
		parent::__construct('#__ra_retention_settings', 'id', $db);

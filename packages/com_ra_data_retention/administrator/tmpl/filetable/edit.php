...
<form
	...
	<?php echo HTMLHelper::_('uitab.addTab', 'myTab', 'retention', Text::_('COM_RA_DATA_RETENTION_TAB_FILETABLE', true)); ?>
	<div class="row-fluid">
		<div class="col-md-12 form-horizontal">
			<fieldset class="adminform">
				<legend><?php echo Text::_('COM_RA_DATA_RETENTION_FIELDSET_FILETABLE'); ?></legend>
				<?php echo $this->form->renderField('tablename'); ?>
				<?php echo $this->form->renderField('columnname'); ?>
			</fieldset>
		</div>
	</div>
